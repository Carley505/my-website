      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-7 flex flex-col gap-4 sm:gap-6 text-brand-muted leading-relaxed"
          >
            ...
            <p className="text-sm sm:text-base">
              Having served as <strong className="text-brand-text font-semibold">Automation Team Lead at m365consult (09/2025 – 02/2026)</strong>, I led cross-departmental automation initiatives across HR, Marketing, and Operations. I architected multi-phase RPA systems (Automa RPA), custom n8n workflows, Power Automate webhooks, and AI-powered applicant evaluation models that significantly reduced manual workloads.
            </p>

            <p className="text-sm sm:text-base">
              Beyond backend workflow architecture, I bring deep <strong className="text-brand-text font-semibold">Full-Stack Development</strong> experience (Next.js, React, Node.js, Python FastAPI) and formal UI/UX graphic design training. This dual perspective allows me to build solutions that run flawlessly behind the scenes while delivering polished, intuitive user interfaces.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 sm:pt-4">
              <div className="p-4 rounded-xl bg-brand-surface border border-brand-border">
                <div className="text-brand-teal font-heading font-semibold text-sm sm:text-base mb-1 flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 flex-shrink-0" /> Systems Automation
                </div>
              ...
              <div className="p-4 rounded-xl bg-brand-surface border border-brand-border">
                <div className="text-brand-violet font-heading font-semibold text-sm sm:text-base mb-1 flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 flex-shrink-0" /> Data & AI Analytics
                </div>
          ...
          >
            <div className="p-5 sm:p-8 rounded-2xl bg-brand-surface border border-brand-border shadow-2xl relative">
              ...
              <h3 className="text-lg sm:text-xl font-heading font-bold text-brand-text mb-5 flex items-center gap-2">
              ...
              <div className="space-y-4 sm:space-y-5 text-xs sm:text-sm">
                ...
                {profileData.experience.map((exp) => (
                  <div key={exp.company} className="flex items-start gap-3">
                    <div className="p-2 rounded-lg bg-brand-bg text-brand-teal mt-0.5 flex-shrink-0">
                      <Briefcase className="w-4 h-4" />
                    </div>
                    <div>
                      <div className="font-semibold text-brand-text">{exp.title}</div>
                      <div className="text-xs text-brand-muted">
                        {exp.company} • {exp.period} {exp.type ? `(${exp.type})` : exp.location ? `(${exp.location})` : ''}
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {/* Certification */}
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-brand-bg text-brand-violet mt-0.5 flex-shrink-0">
                ...
                {/* Location */}
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-brand-bg text-blue-400 mt-0.5 flex-shrink-0">
              ...
              <div className="mt-6 pt-5 border-t border-brand-border flex flex-wrap items-center justify-between gap-3">
                <a
                  ...
                  className="flex items-center gap-1.5 text-xs font-mono text-brand-muted hover:text-brand-teal transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 text-xs font-mono text-brand-muted hover:text-brand-violet transition-colors"
                >
